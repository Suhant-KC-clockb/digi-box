"use client";
import { addUpdateLandingSection1Container1, addupdateSection1Container2 } from "@/actions/landing-page-config/section-1";
import {
  Section1Schema,
  container1Schema,
  container2Schema,
      ...
      >
        <div className="flex gap-4">
          <div className="bg-secondary p-6 rounded-lg  flex flex-col gap-y-4 w-full">
            <div className="text-2xl font-semibold">Container 2</div>
